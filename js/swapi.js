  var response;
             ...
             document.onreadystatechange = function() {
                           if (document.readyState == 'complete') {
                             pegar_personagens();
                             document.querySelector('#starwars').onchange=monstrar_filmes;
                           }
            ...
            if (httpRequest.status === 200) {
                ...
                var lista = document.querySelector('#starwars');
                lista.innerHTML = '';
             ...
             function monstrar_filmes(ev){
                   selected = ev.target;
                   films = JSON.parse(selected.selectedOptions[0].getAttribute('films'));
                var lista = document.querySelector('#films');
                lista.innerHTML = '';                   
